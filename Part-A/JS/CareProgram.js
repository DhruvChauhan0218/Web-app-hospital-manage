                            ...
                            <section>
                                <span class="MuiButtonBase-root MuiIconButton-root jss659 MuiCheckbox-root"
                                    ...
                                    <span class="MuiIconButton-label"> <input class="jss662" type="checkbox"
                                        data-indeterminate="false" value="" onclick="joinCareProgram(this.id)" /></span>
...
// const joinCareProgram=(careProgramId)=>{
//     const payload = {patientId : localStorage.getItem("id"), careProgramId}
//     console.log(careprograms);
//     for (let i = 0; i < careprograms.length; i++) {
//       if(careprograms[i].id==careProgramId){
//         document.getElementById(`${careProgramId}`).checked=true
//       }else{
//         document.getElementById(`${careProgramId}`).checked=false
//        }
//     }
// }